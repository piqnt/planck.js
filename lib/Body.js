...
function Body(world, def) {
  ...
  common.assert(Math.isFinite(def.angularDamping) && def.angularDamping >= 0.0);
  common.assert(Math.isFinite(def.linearDamping) && def.linearDamping >= 0.0);
