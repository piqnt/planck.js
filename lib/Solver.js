...
Solver.prototype.solveIsland = function(step) {
  ...
  for (var i = 0; i < this.m_bodies.length; ++i) {
    ...
    if (body.isDynamic()) {
      ...
      _DEBUG && common.debug("N: " + h, body.m_gravityScale, gravity.x, gravity.y,
  ...
  for (;;) {
    ...
    for (var c = world.m_contactList; c; c = c.m_next) {
      ...
      if (c.m_toiFlag) {
        ...
        _DEBUG && common.debug('sweepA', sweepA.localCenter.x, sweepA.localCenter.y,
            sweepA.c.x, sweepA.c.y, sweepA.a, sweepA.alpha0, sweepA.c0.x,
            sweepA.c0.y, sweepA.a0);

        _DEBUG && common.debug('sweepB', sweepB.localCenter.x, sweepB.localCenter.y,
    ...
    _DEBUG && common.debug("minContact:", minContact == null, 1.0 - 10.0 * Math.EPSILON < minAlpha, minAlpha);
