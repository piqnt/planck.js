...
Solver.prototype.solveIsland = function(step) {
  ...
  for (var i = 0; i < this.m_bodies.length; ++i) {
    ...
    if (body.isDynamic()) {
      ...
      common.debug("N: " + h, body.m_gravityScale, gravity.x, gravity.y,
...
Solver.prototype.solveWorldTOI = function(step) {
  ...
  for (;;) {
    ...
    for (var c = world.m_contactList; c; c = c.m_next) {
      common.debug("alpha0::", c.getFixtureA().getBody().m_sweep.alpha0, c
          .getFixtureB().getBody().m_sweep.alpha0);
      ...
      if (c.m_toiFlag) {
        ...
        common.debug('sweepA', sweepA.localCenter.x, sweepA.localCenter.y,
            sweepA.c.x, sweepA.c.y, sweepA.a, sweepA.alpha0, sweepA.c0.x,
            sweepA.c0.y, sweepA.a0);

        common.debug('sweepB', sweepB.localCenter.x, sweepB.localCenter.y,
    ...
    common.debug("minContact:", minContact == null, 1.0 - 10.0 * Math.EPSILON < minAlpha, minAlpha);
