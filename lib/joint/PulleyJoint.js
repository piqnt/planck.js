...
function PulleyJoint(def, bodyA, bodyB, groundA, groundB, anchorA, anchorB, ratio) {
  ...
  this.m_groundAnchorA = groundA ? groundA : def.groundAnchorA;
  this.m_groundAnchorB = groundB ? groundB : def.groundAnchorB;
  this.m_localAnchorA = anchorA ? bodyA.getLocalPoint(anchorA) : def.localAnchorA;
  this.m_localAnchorB = anchorB ? bodyB.getLocalPoint(anchorB) : def.localAnchorB;
