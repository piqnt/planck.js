...
PrismaticJoint.prototype.solveVelocityConstraints = function(step) {
  ...
  if (this.m_enableLimit && this.m_limitState != inactiveLimit) {
    ...
    // f2(1:2) = invK(1:2,1:2) * (-Cdot(1:2) - K(1:2,3) * (f2(3) - f1(3))) +
    // f1(1:2)
    var b = Vec2.wAdd(-1, Cdot1, -(this.m_impulse.z - f1.z), Vec2(
        this.m_K.ez.x, this.m_K.ez.y)); // Vec2
    var f2r = Vec2.add(this.m_K.solve22(b), Vec2(f1.x, f1.y)); // Vec2
    ...
    var P = Vec2().wAdd(df.x, this.m_perp); // Vec2
