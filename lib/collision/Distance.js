...
function DistanceInput() {
  ...
  this.transformA = null; // Transform
  this.transformB = null; // Transform
  this.useRadii = false;
};
...
function DistanceOutput() {
  this.pointA = Vec2(); // closest point on shapeA
  this.pointB = Vec2(); // closest point on shapeB
  this.distance;
  this.iterations; // number of GJK iterations used
}
...
function SimplexCache() {
  this.metric; // length or area
  this.indexA = []; // vertices on shape A
  this.indexB = []; // vertices on shape B
  this.count = 0;
};
...
function Distance(output, cache, input) {
  ...
  while (iter < k_maxIters) {
    ...
    var wBLocal = new Vec2(); // TODO what is this!
  ...
  common.debug("Distance:", output.distance, output.pointA.x, output.pointA.y,
...
Simplex.prototype.print = function(tag) {
  if (this.m_count == 3) {
    common.debug(tag, "+" + this.m_count, this.m_v1.a, this.m_v1.wA.x,
        this.m_v1.wA.y, this.m_v1.wB.x, this.m_v1.wB.y, this.m_v2.a,
        this.m_v2.wA.x, this.m_v2.wA.y, this.m_v2.wB.x, this.m_v2.wB.y,
        this.m_v3.a, this.m_v3.wA.x, this.m_v3.wA.y, this.m_v3.wB.x,
        this.m_v3.wB.y);
    ...
    common.debug(tag, "+" + this.m_count, this.m_v1.a, this.m_v1.wA.x,
        this.m_v1.wA.y, this.m_v1.wB.x, this.m_v1.wB.y);
