...
function TimeOfImpact(output, input) {
  ...
  _DEBUG && common.debug('sweepA', sweepA.localCenter.x, sweepA.localCenter.y, sweepA.c.x,
      sweepA.c.y, sweepA.a, sweepA.alpha0, sweepA.c0.x, sweepA.c0.y, sweepA.a0);

  _DEBUG && common.debug('sweepB', sweepB.localCenter.x, sweepB.localCenter.y, sweepB.c.x,
