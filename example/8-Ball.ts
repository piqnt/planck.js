import { World, Circle, Settings, Polygon, Vec2Value, Contact, Body } from "planck";
...
interface EightBallContext extends TestbedContext {
  game: EightBallState;
}
...
class BilliardPhysics extends Middleware<EightBallContext> {
  ...
  handleActivate() {
    ...
    this.context.world.value.on("begin-contact", this.collide);
  }
...
const context: EightBallContext = { ...initTestbedContext(), game: new EightBallState() };
context.mouseForce.value = -20;
