import { World, Vec2Value, Circle, Chain, Settings, Contact, Body } from "planck";
...
interface ShuffleContext extends TestbedContext {
...
class ShufflePhysics extends Middleware<ShuffleContext> {
  ...
  handleActivate() {
    ...
    this.context.world.value.on("begin-contact", this.handleBeginContact.bind(this));
  }
...
const context: ShuffleContext = { ...initTestbedContext(), shuffle: new ShuffleState() };
context.mouseForce.value = -100;
