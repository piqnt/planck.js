...
planck.play('Breakable', function(pl) {
  ...
  {
    m_body1 = world.createDynamicBody({
      position : Vec2(0.0, 40.0),
      angle : 0.25 * Math.PI
    });

    m_shape1 = pl.Box(0.5, 0.5, Vec2(-0.5, 0.0), 0.0);
    m_piece1 = m_body1.createFixture(m_shape1, 1.0);

    m_shape2 = pl.Box(0.5, 0.5, Vec2(0.5, 0.0), 0.0);
  ...
  function Break() {
    ...
    var velocity1 = m_velocity + Cross(m_angularVelocity, center1 - center);
    var velocity2 = m_velocity + Cross(m_angularVelocity, center2 - center);
