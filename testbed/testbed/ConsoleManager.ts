...
interface ConsoleManagerContext {
  console: ConsoleInterface;
}

export class ConsoleManager extends Middleware<ConsoleManagerContext> implements ConsoleInterface {
